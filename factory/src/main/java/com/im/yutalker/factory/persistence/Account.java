package com.im.yutalker.factory.persistence;
...
public class Account {
    ...
    public static void login(AccountRspModel model) {
        // 存储当前登录的account，Token，用户Id，方便从数据库中查询我的信息
    ...
    public static User getUser() {
        User user = SQLite
                ...
                .querySingle();
        // userId如果为空 就new一个User 否则 从数据库中查询
        return TextUtils.isEmpty(userId) ? new User() : user;
    }
